...
Implemented 2026-09-14. Approved for publication on 2026-09-15.
...
Verified: Astro check, 37-page build, 14 tests; 21 representative routes at 1440px and 320px; persisted selection, OS preference changes, CSS fallback, mobile menu, article search, QC batch-release interaction and code syntax colors. Light and dark screenshots reviewed. Publication authorized on 2026-09-15.
